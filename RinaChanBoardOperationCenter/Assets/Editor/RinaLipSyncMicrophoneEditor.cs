...
{
    [CustomEditor(typeof(RinaLipSyncMicrophone))]
    public class RinaLipSyncMicrophoneEditor : Editor
    {
        RinaLipSyncMicrophone mic => target as RinaLipSyncMicrophone;
        ...
        void DrawProps()
        {
            if (EditorUtil.Foldout("Device", true, "-rinaLipSync-Microphone"))
            {
            ...
            if (EditorUtil.Foldout("Advanced", false, "-rinaLipSync-Microphone"))
            {
                ++EditorGUI.indentLevel;
            ...
            if (EditorUtil.Foldout("Information", true, "-rinaLipSync-Microphone"))
            {
