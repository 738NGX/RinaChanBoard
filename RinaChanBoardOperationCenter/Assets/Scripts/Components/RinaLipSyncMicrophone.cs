...
namespace RinaLipSync
{
    ...
    public class RinaLipSyncMicrophone : MonoBehaviour
    {
        ...
        [Tooltip("当开启时，麦克风输入的 AudioClip 会自动注册到 AudioSource")]
        public bool isAutoStart = true;

        [Range(0.01f, 0.2f)]
        [Tooltip("重新同步麦克风和音频源的阈值时间")]
        public float latencyTolerance = 0.05f;

        [Range(0.01f, 0.2f)]
        [Tooltip("将麦克风输入反映为音频源的缓冲时间（太低会导致噪音）")]
